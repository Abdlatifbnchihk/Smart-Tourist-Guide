# Driver Transport Booking Management

## Purpose

Provides driver-facing endpoints for listing, viewing, and updating status of transport bookings assigned to them, with status transition validation enforcing a finite state machine.
