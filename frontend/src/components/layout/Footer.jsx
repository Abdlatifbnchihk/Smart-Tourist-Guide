    ...
    <footer className="bg-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Smart Tourist Guide</span>
            </Link>
            <p className="text-slate-400 mb-4">Discover Morocco's hidden gems with AI-powered trip planning.</p>
        ...
        <div className="border-t border-slate-800 mt-8 pt-8 text-center text-slate-400 text-sm">
          <p>&copy; 2026 Smart Tourist Guide. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
