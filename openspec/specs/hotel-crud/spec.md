...
Hotel CRUD operations with ownership validation for the Smart Tourist Guide Morocco platform. Allows hotel owners to create, read, update, and delete their hotels.
