...
Provides RESTful API endpoints for hotel managers to manage their own hotels, including listing, creating, viewing, updating, and deleting hotels with ownership validation and auto-assignment of creator.
