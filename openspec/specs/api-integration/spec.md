...
Defines how the frontend communicates with the Laravel REST API backend, including Axios configuration, React Query integration, React Router setup, and the Vite dev proxy.
