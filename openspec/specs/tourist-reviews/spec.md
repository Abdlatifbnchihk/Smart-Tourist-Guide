...
Tourist-facing review management - viewing, editing, and deleting personal reviews.
...
- **THEN** the system fetches `GET /api/v1/reviews` (scoped to current user) and displays a list with: entity name, rating, comment snippet, date, and edit/delete buttons
...
- **WHEN** the tourist clicks the "Delete" button on a review
...
- **WHEN** the tourist clicks the "Edit" button on a review
