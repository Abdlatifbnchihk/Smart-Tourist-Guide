...
- [x] 1.1 Create migration file for attractions table with all MLD columns
- [x] 1.2 Add foreign key constraint on city_id to cities.city_id (RESTRICT on delete)
- [x] 1.3 Add index on city_id column

## 2. Model

- [x] 2.1 Create Attraction Eloquent model
- [x] 2.2 Define belongsTo(City::class) relationship
- [x] 2.3 Define hasMany(Review::class) relationship
- [x] 2.4 Define hasMany(Favorite::class) relationship
